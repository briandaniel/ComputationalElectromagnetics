...
spaceSize = 3.5e-6;            % Space size (1 = 1meter)                  [USER DEFINED]
...
[lambdas, R] = bragg(512e-9, nH, nL, 13);

figure('outerposition', [100   500   800   500])
plot(lambdas.*10^9, R, lambdaDom*10^9, refl.^2, 'r-')

% plot(lambdas.*10^9, TP)
legend('Reflection calculated', 'Reflection from simulation', '= 1-trans')
ylabel('Power')
xlabel('Wavelength(nm)')
axis([min(lambdas)*10^9 max(lambdas)*10^9 0 1.1])

...
maxIter = 4200;                 % Maximum number of iterations + 1         [USER DEFINED]
...
posMed = 1000;                   % Position of mediunm                      [USER DEFINED]
...
%%%%%% MAIN SOLUTION LOOP %%%%%%
figure('outerposition', [500   100   600   400])
set(1,'color',[.9 .9 .9])
...
movie2avi(M, 'Gauss Pulse 1D Debye4 Media', 'fps', 20);

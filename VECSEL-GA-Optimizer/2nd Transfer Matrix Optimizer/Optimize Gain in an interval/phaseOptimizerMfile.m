...
lambdaWindowOpt = [ 973, 975]*1e-9;
lambdaStepsOpt = 10;
optNum = 1000;                   % Number of loops that the optimizer conducts
...
variables = length(L);
options = gaoptimset('tolfun', 1e-2, 'populationsize', 20+length(storage(:,1)), 'timelimit', inf, ...

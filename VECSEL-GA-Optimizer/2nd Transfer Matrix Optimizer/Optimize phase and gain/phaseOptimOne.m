function [compilation] = phaseOptimOne(lambdaMin, lambdaMax, lambdaSteps, n, L, sigma, tolerance)
...
compilation = gainSumInv + phaseCurveNorm*tolerance;
compilation = phaseCurveNorm;

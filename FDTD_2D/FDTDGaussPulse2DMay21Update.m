...
sourcePos = [.4*planeSize, .6*planeSize];   % Location of source           [USER DEFINED]
...
%%%%%% MAIN SOLUTION LOOP %%%%%%
% figure('outerposition', [250  250   780   622])
...
title('Sine Wave Source 2D Propagation')
xlabel('x')
ylabel('y')
zlabel('Ez')
...
movie2avi(M, 'Sine Source 23D MUR Boundary Update1413', 'fps', 20);
